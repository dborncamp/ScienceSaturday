...
for i,ax in enumerate(axes.flatten()):
    ...
    ax.pie(color_color.iloc[i],colors=colors,autopct='%1.1f%%')
    ax.text(0.,-1.2,color_color.index[i].upper(),ha='center')


plt.suptitle('Starburst - Color guessed by color')
plt.savefig('starburst_pie.png',bbox_inches='tight')
plt.close()
